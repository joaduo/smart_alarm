'''
This is a dummy version of androidhelper.py
So we can test android_server.py in a non-android machine.
'''
#-------------------------------------------------------------------------------
...
class Android(object):
    def _rpc(self, method, *args, **kwargs):
        return Result(id=1, result=dict(method=method, args=args, kwargs=kwargs), error=None)
